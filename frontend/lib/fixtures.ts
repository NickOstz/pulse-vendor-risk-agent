...
export const companiesFixture: Company[] = [
  ...
  },
  {
    ...
    relationship_type: "cloud infrastructure",
    owner: "IT",
    criticality: "critical",
    renewal_date: "2026-12-31",
    allow_list: ["https://aws.amazon.com/security/", "https://aws.amazon.com/compliance/"],
    block_list: [],
    agent_enabled: false,
    agent_status: "inactive",
    review_policy: null,
  ...
  {
    id: "vendor_lemon_squeezy",
    name: "Lemon Squeezy",
    domain: "lemonsqueezy.com",
    relationship_type: "merchant of record",
    owner: "Finance",
    criticality: "important",
    renewal_date: "2026-12-31",
    allow_list: ["https://www.lemonsqueezy.com/terms", "https://www.lemonsqueezy.com/privacy"],
    block_list: [],
    agent_enabled: false,
    agent_status: "inactive",
    review_policy: null,
  ...
  },
  {
    ...
    name: "Vercel",
    domain: "vercel.com",
    relationship_type: "application hosting",
    owner: "Engineering",
    criticality: "important",
    renewal_date: "2026-12-31",
    allow_list: [
      "https://vercel.com/security",
      "https://vercel.com/kb/guide/ensuring-safe-and-effective-infrastructure-testing",
